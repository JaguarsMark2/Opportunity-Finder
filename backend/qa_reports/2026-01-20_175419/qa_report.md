...
Generated: 2026-01-20T17:54:19.308440Z
## Checks
...
| FAIL | Scan endpoint rejects non-admin users | login for scan admin check failed: {   "error": "Rate limit exceeded",   "retry_after": 50 }  |
| FAIL | Admin can trigger scan and check progress | admin login failed: 429 - {   "error": "Rate limit exceeded",   "retry_after": 50 }  |
| FAIL | Scan progress with fake ID does not 500 | login for fake scan check failed: {   "error": "Rate limit exceeded",   "retry_after": 49 }  |
...
## Notes
- Register status=201 (email=qa-b44eba9d@example.com)
